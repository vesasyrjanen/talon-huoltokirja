...
export function OverdueMaintenanceCard({
  items,
}: {
  ...
  return (
    <div className="rounded-2xl border bg-white p-5 shadow-sm">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold">Myöhässä olevat huollot</h2>
            ...
            return (
              ...
              >
                ...
                <div className="mt-1 text-sm text-red-700">
                  Erääntynyt: {item.next_service_date}
                </div>
              </Link>
            );
          })}
